...
| **Care**           | 펫케어 요청, 제안/수락 계약, 이행 완료 확인, 리뷰 시스템                            |
...
- **Care**: OPEN → IN_PROGRESS → COMPLETED 상태. 계약은 요청자의 제안을 제공자가 수락할 때 성립하고, 진행 중으로 가는 길은 그 경로 하나뿐
- **Payment**: 펫코인 에스크로, 비관적 락, Care 제안 수락 시 지급 대상 배정
