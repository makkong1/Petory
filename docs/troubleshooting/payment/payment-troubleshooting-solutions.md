...
5. **잔액 확인과 차감 사이의 Race Condition (2.2)** - 2026-01-28 완료 (비관적 락 추가)
6. **에스크로 상태 변경 시 Race Condition (2.3)** - 2026-01-28 완료 (비관적 락 추가)
...
- 2026-01-28: 잔액 확인과 차감 사이의 Race Condition 해결 (2.2)
- 2026-01-28: 에스크로 상태 변경 시 Race Condition 해결 (2.3)
...
- [ ] 동시성 문제 - 에스크로 중복 생성 (2.1) - 부분 해결 (DB 제약조건 있음)
