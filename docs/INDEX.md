...
frontmatter가 붙은 문서 34건. 각 문서 상단에 `date/domains/type/problem/status/metric` YAML을 붙이면 자동으로 여기 잡힌다.
...
| **증거** | 이 인덱스가 잡은 34건 | 측정·실험 기록. **통합하지 않는다** — 흩어져 있어야 "이 숫자 어디서 났나"에 링크를 던질 수 있다 |
