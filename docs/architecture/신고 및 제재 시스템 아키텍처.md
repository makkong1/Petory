...
graph TB
    ...
    subgraph "Backend API Layer"
        ...
        AC[Admin Controllers<br/>신고 처리]
    end
    
    subgraph "Service Layer"
        RS[ReportService<br/>신고 생성, 처리]
        USS[UserSanctionService<br/>제재 적용, 해제]
    end
    
    subgraph "Scheduler"
        USSCH[UserSanctionScheduler<br/>만료된 제재 자동 해제]
    end
    ...
    subgraph "Domain Targets"
        ...
        MissingPet[MissingPetBoard<br/>실종 제보]
        Provider[Users<br/>서비스 제공자]
    end
...
sequenceDiagram
    ...
    RS->>RS: 입력 검증<br/>(targetType, targetIdx, reason)
    ...
    alt 중복 신고
        RR-->>RS: true
        RS-->>RC: IllegalStateException<br/>("이미 해당 대상을 신고하셨습니다.")
    else 중복 없음
        RR-->>RS: false
