...
class MissingPetBoardConcurrencyTest {
    ...
    void setUp() {
        ...
        // deleteBoard() 는 SecurityContext 의 현재 사용자로 소유권을 검증한다(assertOwner).
        // 게시글 작성자(testUser1)로 인증 상태를 설정해야 삭제가 허용된다.
        CustomUserDetails principal = CustomUserDetails.from(testUser1);
